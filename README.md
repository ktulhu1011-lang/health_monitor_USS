...
Ожидается wide-формат:

- системные колонки: `timestamp` (или `updated_at`), `studio_code`, `studio_name` (опционально), `period_code`
- остальные колонки трактуются как `metric_code`
